...
const (
	...
	ERROR_COMMENT_DELETE_AUTH = 5002
	...
	ERROR_ROLE_NAME_EXIST       = 6010
	ERROR_ROLE_NOT_EXIST        = 6011

	// code=7000 ... 页面模块的错误
	ERROR_PAGE_NAME_EXIST = 7001

	// code=8000 ... 视频模块的错误
	ERROR_VIDEOID_WRONG   = 8001
	ERROR_VIDEO_NOT_EXIST = 8002

	// code=10000 ... 收藏夹模块的错误
	ERROR_UPDATE_COLLECTION         = 10001
	ERROR_COLLECTION_NOT_EXIST      = 10002
	ERROR_COLLECTION_NAME_REPEAT    = 10003
	ERROR_COLLECTION_VIDEO_MISMATCH = 10004
)
...
var codeMsg = map[int]string{
	...
	ERROR_COMMENT_DELETE_AUTH: "无权限删除该评论",
	...
	ERROR_UPDATE_COLLECTION:         "更新收藏夹失败",
	ERROR_COLLECTION_NOT_EXIST:      "收藏夹不存在",
	ERROR_COLLECTION_NAME_REPEAT:    "收藏夹名称重复",
	ERROR_COLLECTION_VIDEO_MISMATCH: "收藏夹与视频不匹配",
}
